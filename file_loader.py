...
class File_Loader():
    ...
    def sample_station(self, datatype):
        ...
        for index, t in enumerate(time_range_list):
            ...
            for station_idx in range(0, volume_data.shape[1]):
                ...
                including:
                    ...
                    2. att_flow_features
                    3. att_lstm_features
                    4. poi_features (same as short term poi features)
                """
        ...
        return output_nbhd_att_features, output_flow_att_features, att_lstm_features,\
            short_nbhd_features, short_flow_features, short_lstm_features, poi_features,\
            labels
    ...
    def sample_region(self, datatype):
        ...
        return output_nbhd_att_features, output_flow_att_features, lstm_att_features, \
