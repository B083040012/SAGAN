...
class Supernet_Training():
    ...
    def load_data(self, logger):
        ...
        if self.dataset_type == "station":
            att_cnn, att_flow, att_lstm, short_cnn, short_flow, short_lstm, short_poi, y = my_data_loader.sample(datatype = "train")
            self.train_data = [att_cnn, att_flow, att_lstm, short_cnn, short_flow, short_lstm, short_poi]
            self.train_label = y
            ...
            att_cnn, att_flow, att_lstm, short_cnn, short_flow, short_lstm, y = my_data_loader.sample(datatype = "train")
            self.train_data = [att_cnn, att_flow, att_lstm, short_cnn, short_flow, short_lstm]
            self.train_label = y
